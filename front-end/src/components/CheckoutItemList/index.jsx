...
import { CheckoutItensContainer, H1, TotalContainer, PaperDiv, Div } from './styles';
import { getPrice } from '../../utils/formatManipulation';
import { useCheckoutTable } from '../../hooks';

const CheckoutItemList = () => {
    const { totalPrice, removeFromCart, tableHeaderItens, cartState, clearStorageCart, getDataTestId } = useCheckoutTable();
    ...
    return (
        <CheckoutItensContainer>
            ...
            <TotalContainer>
                <h1 data-testid={ getDataTestId("totalPrice") }> { `Total: ${totalPrice}` } </h1>
            </TotalContainer>
        </CheckoutItensContainer>
    );
}
